import {
  ...
  const EditObra = () => {
    ...
    const handleFormSubmit = (values) => {
        clienteAxios
          .post(`/api/ordenTra/editar/${selectedOrdenId}`, values)
          .then((response) => {
    ...
    return (
      <div className="FormMat">
        <Header
          ...
          subtitle="Actualiza una orden de Trabajo"
        />
        <div className="Formulario">
          ...
          <Dialog open={open} onClose={handleClose}>
            <DialogTitle>Orden Actualizada correctamente</DialogTitle>
          </Dialog>
          <div className="Boton">
