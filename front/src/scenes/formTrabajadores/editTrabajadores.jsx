...
import clienteAxios from "../../helpers/clienteAxios";
  ...
  const EditTra = () => {
    ...
    const [selectedTraId, setSelectedTraId] = useState('');
    ...
    useEffect(() => {
      ...
      const handleFormSubmit = (values) => {
        clienteAxios
          .post(`/api/tra/editar/${selectedTraId}`, values)
          .then((response) => {
      ...
      <div className="FormMat">
        ...
        <div className="Formulario">
            ...
            {({
              ...
              <form onSubmit={handleSubmit}>
                ...
                >
                  ...
                  onChange={(e) => {
                    handleChange(e);
                    setSelectedTraId(e.target.value);
                    console.log(selectedTraId);
                  }}
                  value={selectedTraId}
                  name="nombre"
          ...
          <Dialog open={open} onClose={handleClose}>
            <DialogTitle>Trabajador Actualizado correctamente</DialogTitle>
          </Dialog>
          <div className="Boton">
